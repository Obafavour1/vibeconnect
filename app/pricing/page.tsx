...
const page = () => {
  return (
    <main className="bg-black text-white">
      <div>
        <section className="pt-20 h-[500px] sm:pt-24 md:pt-32 lg:pt-40 px-4 sm:px-8 md:px-16 lg:px-24 bg-[url('/images/pricingHeroBg.png')] bg-cover min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-screen bg-no-repeat">
